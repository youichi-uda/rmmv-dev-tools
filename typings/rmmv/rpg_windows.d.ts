...
declare class Window_BattleLog extends Window_Selectable {
    ...
    showActorAttackAnimation(subject: Game_Actor | Game_Enemy, targets: (Game_Actor | Game_Enemy)[]): void;
    showEnemyAttackAnimation(subject: Game_Actor | Game_Enemy, targets: (Game_Actor | Game_Enemy)[]): void;
    ...
    displayAction(subject: Game_Actor | Game_Enemy, item: any): void;
