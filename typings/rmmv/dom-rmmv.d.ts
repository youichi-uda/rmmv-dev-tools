// ============================================================================
// dom-rmmv.d.ts — Minimal DOM type declarations for RMMV plugin development
// ============================================================================
//
// This file provides the subset of DOM / Web API types referenced by the RMMV
...
// "Window" and "StorageManager" that conflict with the RMMV classes of the
// same name.
//
...
interface CSSStyleDeclaration {
    ...
    // Common properties used by RMMV
    width: string;
    height: string;
    margin: string;
    padding: string;
...
// interface, to avoid conflicting with the RMMV Window class.
...
// ---------------------------------------------------------------------------
// FontFace API (used by RMMV FontManager)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Image constructor (used by RMMV for new Image())
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Audio constructor (used by RMMV for new Audio())
// ---------------------------------------------------------------------------
...
// localForage — used by RMMV for web storage fallback
declare var localforage: any;

// nw.js — NW.js API used by RMMV desktop builds
declare var nw: any;
